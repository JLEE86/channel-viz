(function ( $ ){
	...
	EXAMPLE CONFIGURATION
		...
		applicationName	= 'Test Data', // Replaces Xively logo in the header
	...
	*/
	...
	var defaultKey		= 'yWYxyi3HpdqFCBtKHueTvOGoGROSAKxGRFAyQWk5d3JNdz0g', // Unique master Xively API key to be used as a default
		defaultFeeds	= '61916!sine60' // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Test Data', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 10800, // Default interval for data to be displayed (in seconds)
